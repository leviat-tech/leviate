<template>
  <LvErrorBoundary :instance="entity">
    <DViewport current-tool="select" data-cy="viewport_2d" :padding="0.5" show-grid>
      <DEditableShape
        :key="entity.id"
        :shape="shapeParams"
    ...
    <DToolbar :items="toolbarItems" :formatter="(tool) => $l(`tooltip_${tool}`)" />
  </LvErrorBoundary>
</template>
...
function onUpdate(params) {
  ...
  // const { vertices, location, id } = params
