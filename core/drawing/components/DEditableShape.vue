...
const isHorizontal = props.sectionLine?.viewDirection === 'top' || props.sectionLine?.viewDirection === 'bottom';
...
const sectionPath = computed(() => {
  ...
  if (isHorizontal) {
    const a = {
      x: e.xmin - pathOffset,
      y: props.sectionLine?.viewDirection === 'bottom' ? sectionCutTemp.value.a.y + pathOffset : sectionCutTemp.value.a.y - pathOffset,
    };
    const b = { x: e.xmin - pathOffset, y: sectionCutTemp.value.a.y };
    const c = { x: e.xmax + pathOffset, y: sectionCutTemp.value.b.y };
    const d = {
      x: e.xmax + pathOffset,
      y: props.sectionLine?.viewDirection === 'bottom' ? sectionCutTemp.value.b.y + pathOffset : sectionCutTemp.value.b.y - pathOffset,
    };
    return `M${a.x},${a.y} L${b.x},${b.y} L${c.x},${c.y} L${d.x},${d.y}`;
  }
  const a = {
    x: props.sectionLine?.viewDirection === 'left' ? sectionCutTemp.value.a.x + pathOffset : sectionCutTemp.value.a.x - pathOffset,
    y: e.ymin - pathOffset,
  };
