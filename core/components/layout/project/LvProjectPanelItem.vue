  ...
  <Disclosure v-slot="{ open }">
    <DisclosureButton
      ...
      :class="{
          ...
          'flex-1 text-center bg-gray-50 text-gray-500 border-t border-t-gray-200' : !isExpanded,
          'border-r-4 border-indigo text-indigo' : !isExpanded && isActive,
          'text-indigo' : isExpanded && isActive
        }">
      ...
      <div v-if="isExpanded && isActive" class="triangle-down absolute top-11 left-2"/>
    </DisclosureButton>
